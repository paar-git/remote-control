 ...
 *
 * Nothing else belongs in the top navigation. Session tools live inside a
 * session; file transfer is a permission, not a destination.
 */

import { Activity, HardDrive, Monitor, Settings, type LucideIcon } from 'lucide-react';
